...
import { ItemDetailsCarousel, ItemDetailsSummary } from '../../components/_dashboard/asset/details';
...
export default function TokenDetail() {
  ...
  return (
    <Page title="Ecommerce: Item Details | Minimal-UI">
      {itemDetail ? (
